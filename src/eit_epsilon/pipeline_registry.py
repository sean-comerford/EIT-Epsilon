...
# from pipelines.energy_forecasting.data_extraction import energy_production as extract_energy_production
...
def register_pipelines() -> Dict[str, Pipeline]:
    ...
    day_ahead_model_training_pipeline = pipeline(
        pipe=energy_production_pipeline + weather_stations_pipeline +
             weather_measurements_pipeline + data_funnel_training_and_testing_pipeline +
             weather_forecasts_testing_pipeline + modeling_training_pipeline +
             modeling_testing_pipeline + exploration_pipeline,
        parameters={
